...
# D:\DPF-2.0\Get_Thresholds_miliseconds.py
...
def extract_PID_data(data, PROTOCOL,LABEL):
    ...
    if (PROTOCOL == 'SAE'):
        ...
        if LABEL == 'IMAP':
            ...
            PID_TAG = '3236'
        elif LABEL == 'DPFDP': # DPF Diffrential Pressure (across DPF) # 3700
            #PID_TAG = '7ABC'#'3251'
            PID_TAG = '3251'
        elif LABEL == 'DOCOUT': # DPF Diffrential Pressure (across DPF) # 3700
            #PID_TAG = '7ABC'#'3251'
            PID_TAG = '4766'    
        ...
        if LABEL == 'ENGINE LOAD':
            ...
            PID_TAG = '3719' #  #3719 generic check     
        elif LABEL == 'ACTIVEREGEN':
            PID_TAG = '3700' # 245
        ...
        if LABEL == 'ENGINE LOAD':
        ...
        elif LABEL == 'DOCOUT': # DPF Diffrential Pressure (across DPF)
            PID_TAG = 'spn_4766_avg'    
        elif LABEL == 'SPEED': # Wheep based Vehicle Speed
            PID_TAG = 'spn_84_avg'
        elif LABEL == 'DPFINT':# DPF in Temperature Before DPF (DOC out)
            ...
            PID_TAG = 'spn_3719_avg' #  #3719 generic check 5466    
        elif LABEL == 'ACTIVEREGEN':
...
if __name__ == '__main__':
    ...
    dir_list = ['1318339573616476160']
    PROTOCOL = 'SAE_AVG_SPN'
    ...
    for file in dir_list:
        ...
        #OBD_data_path = "D:/Work/DPF_story/" + file
        vehicle_id =  '1318339573616476160' #412-Kenworth T880 Dump Truck Tier 3 (Cummins X15)
        # Start_TS =  1721747566125
        # End_TS = 1722902340000
        Start_TS =  1723680000000
        End_TS =  1723939140000
        ...
        plt.axhline(y=7, xmin=0, xmax=len(X_Time), color='r',linestyle='--')
        plt.title(LABEL)
